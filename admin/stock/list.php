...
<body id="body-pd">
    ...
    <div>
        ...
        <div class="nav_list">
            ...
            <a href="../stock/list.php" class="nav_link active">
...
if (isset($_GET['edit']) && $_GET['edit'] =="ok"){
    ...
    quantite modifiée avec succées
</div>';
}
  ...
  <?php foreach($stock as $index => $s) { ?>
      <tr>
        ...
        <td>
          ...
          <a data-bs-toggle="modal" data-bs-target="#modifModal<?php echo $s['id']; ?>" class="btn btn-success">Modifier</a>
        </td>
      </tr>
    <?php } ?>
  </tbody>
...
<?php 
foreach($stock as $index => $s) { ?>

<!-- Modal Modifier -->
<div class="modal fade" id="modifModal<?php echo $s['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="modifier.php" method="POST">
          <input type="hidden" value="<?php echo $s['id']; ?>" name="ids" required>
          <div class="mb-3">
            <input type="number" class="form-control" name="nom" value="<?php echo $s['quantite']; ?>" placeholder="Quantite" required>
          </div>
      </div>
