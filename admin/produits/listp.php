...
<body id="body-pd">
    ...
    <div>
        ...
        <div class="nav_list">
            ...
            <a href="../produits/listp.php" class="nav_link active">
    ...
    <div class="modal-content">
      ...
      <form action="ajout.php" method="POST" enctype="multipart/form-data">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nom" placeholder="Enter name product" required>
          </div>
          <div class="mb-3">
           
            <textarea class="form-control" name="description" rows="3" placeholder="Enter description product" ></textarea>
          </div>

          <div class="mb-3">
          
          <input type="number"  step="0.01" class="form-control" name="prix" placeholder="Enter price" required>
        </div>
        ...
        <select class="form-control" name="categorie" placeholder="Select category" required>
        <?php
...
<div class="modal fade" id="editModal<?php echo $categorie['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered"> 
    <div class="modal-content">
      ...
      <input type="hidden" value="<?php echo $produit['id'] ;  ?>" name="idp" required>
          <div class="mb-3">
          
            <input type="text" class="form-control" name="nom" placeholder="Enter name product" <?php echo $produit['nom']; ?> required>
          </div>
          <div class="mb-3">
           
            <textarea class="form-control" name="description" rows="3" placeholder="Enter description product" ><?php echo $produit['description']; ?></textarea>
          </div>

          <div class="mb-3">
          
          <input type="number"  step="0.01" class="form-control" name="prix" placeholder="Enter price" <?php echo $produit['prix']; ?> required>
        </div>
        ...
        <select class="form-control" name="categorie" placeholder="Select category"  <?php echo $produit['categorie']; ?>required>
        <?php
     foreach( $categories as $index => $c)
